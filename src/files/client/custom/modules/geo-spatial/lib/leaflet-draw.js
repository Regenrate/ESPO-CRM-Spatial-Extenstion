define('leaflet-draw', ['leaflet'], (function (L) { 'use strict';

	function getDefaultExportFromCjs (x) {
		return x && x.__esModule && Object.prototype.hasOwnProperty.call(x, 'default') ? x['default'] : x;
	}

	var leaflet_drawSrc$1 = {};
	...
	var hasRequiredLeaflet_drawSrc;

	function requireLeaflet_drawSrc () {
		if (hasRequiredLeaflet_drawSrc) return leaflet_drawSrc$1;
		hasRequiredLeaflet_drawSrc = 1;
		...
		return leaflet_drawSrc$1;
	}

	var leaflet_drawSrcExports = requireLeaflet_drawSrc();
	var leaflet_drawSrc = /*@__PURE__*/getDefaultExportFromCjs(leaflet_drawSrcExports);

	return leaflet_drawSrc;
